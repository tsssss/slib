...
;---Save the data to CDF.
    ...
    offn = join_path([local_dir,base_name])
    ...
    if file_test(offn) eq 1 then file_delete, offn
    scdfwrite, offn, gattribute=ginfo, compress=compress
    ...
    scdfwrite, offn, utname, value=times, attribute=ainfo, cdftype='CDF_DOUBLE'
    ...
    ainfo = {$
        ...
        units: 'pixel', $
        var_type: 'support_data'}
    scdfwrite, offn, varname, value=dat, attribute=ainfo, cdftype='CDF_UINT4', $
        dimvary=[1], dimensions=[2]
    ...
    ainfo = {$
        ...
        units: 'deg', $
        var_type: 'support_data'}
    scdfwrite, offn, varname, value=min_lat, attribute=ainfo, cdftype='CDF_FLOAT'
    ...
    ainfo = {$
        ...
        validmax: 12, $
        var_type: 'support_data'}
    scdfwrite, offn, varname, value=dat, attribute=ainfo, cdftype='CDF_FLOAT', $
        dimvary=[1,1], dimensions=img_size
    ...
    ainfo = {$
        ...
        depend_0: utname, $
        var_type: 'data'}
    scdfwrite, offn, index_name, value=dat, attribute=ainfo, cdftype='CDF_UINT4', $
    ...
    ainfo = {$
        ...
        depend_1: index_name, $
        var_type: 'data'}
    scdfwrite, offn, value_name, value=dat, attribute=ainfo, cdftype='CDF_FLOAT', $
        compress=compress, dimvary=[1], dimensions=[npixel]
    ...
    ainfo = {$
        ...
        depend_1: index_name, $
        var_type: 'data'}
    scdfwrite, offn, elev_name, value=dat, attribute=ainfo, cdftype='CDF_FLOAT', $
        compress=compress, dimvary=[1], dimensions=[npixel]
