...
pro themis_asf_load_mlon_image_rect_per_site_gen_file, time, site=site, filename=file, errmsg=errmsg, calibration_method=calibration_method
...
themis_asf_load_mlon_image_rect_per_site_gen_file, time_range, site=site, filename=file, errmsg=errmsg
end
