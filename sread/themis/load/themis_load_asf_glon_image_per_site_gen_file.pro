...
pro themis_load_asf_glon_image_per_site_gen_file, time, site=site, filename=file, errmsg=errmsg
...
themis_load_asf_glon_image_per_site_gen_file, time_range, site=site, filename=file, errmsg=errmsg
end
