...
function themis_load_asf_mlon_image_rect_per_site, input_time_range, site=site, id=datatype, $
...
foreach site, sites do files = themis_load_asf_mlon_image_rect_per_site(time_range, site=site)
end
