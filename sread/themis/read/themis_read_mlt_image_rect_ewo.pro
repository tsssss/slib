...
;---Preparation.
    ...
    hehe = total(data[*,mlt_index,mlat_index],3)/nybin
    ybins = mlt_bins[mlt_index]
    xbins = mlat_bins[mlat_index]
    yrange = mlt_range
    xrange = mlat_range
    ytitle = 'MLT (h)'
...
ewo_var = themis_read_mlt_image_rect_ewo(time_range, mlt_range=mlt_range, mlat_range=mlat_range, mlt_image_var=mlt_image_var)
