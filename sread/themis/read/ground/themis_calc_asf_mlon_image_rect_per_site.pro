...
pro themis_calc_asf_mlon_image_rect_per_site, asf_var, errmsg=errmsg, no_crop=no_crop
...
;---Map ASF image to MLon-MLat image.
    ...
    mlon_images = mlon_image_rect_map_old2new(asf_images, site=site, crop=crop)
    ...
    pixel_mlat = mlon_image_rect_info.pixel_mlat
    pixel_xpos = mlon_image_rect_info.pixel_xpos
    pixel_ypos = mlon_image_rect_info.pixel_ypos
...
themis_calc_asf_mlon_image_rect_per_site, asf_var, crop=1
