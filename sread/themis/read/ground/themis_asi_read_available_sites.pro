...
function themis_asi_read_available_sites, input_time, sites=sites, id=datatype, errmsg=errmsg, urls=urls
...
sites = themis_asi_read_available_sites(time, id='l1%ast', urls=urls)
end