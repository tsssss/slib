;+
; Read THEIS keV proton flux. Save as 'thx_kev_e_flux'.
;
;-

pro themis_read_kev_proton, time_range, probe=probe, errmsg=errmsg, energy=energy, pitch_angle=pitch_angle

    pre0 = 'th'+probe+'_'

    themis_read_sst, time_range, id='l2%h_kev', probe=probe

    get_data, pre0+'h_energy', times, energy_bins
    ...
    get_data, pre0+'h_flux', times, flux
    flux = flux[*,index]
...
themis_read_kev_proton, time_range, probe='e'
end
