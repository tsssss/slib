...
if check_if_update(glon_image_var) then themis_asf_read_glon_image, time_range, sites=sites
...
if check_if_update(mlt_image_var) then themis_asf_read_mlt_image, time_range, sites=sites
