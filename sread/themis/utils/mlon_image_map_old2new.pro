...
function mlon_image_map_old2new, old_images, site=site, crop=crop
    ...
    themis_read_asf_mlon_image_read_mapping_info, input_time_range, site=site
...
;old_pixels = site_info.pixel_mlon
;crop = 0
...
; mean, 127 sec.
; median, 113 sec.
imgs_raw = mlon_image_map_old2new(imgs, site=site, crop=crop)
stop
