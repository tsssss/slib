;+
; Read DMSP energy-time spectrogram.
; This is wrapper to try various data sources.
; madrigal and cdaweb are the same.
;-

function dmsp_read_en_spec, input_time_range, probe=probe, errmsg=errmsg, get_name=get_name, suffix=suffix, _extra=ex

    sources = ['madrigal','cdaweb']
    foreach source, sources do begin
        func_name = 'dmsp_read_en_spec_'+source
