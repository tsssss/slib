...
function dmsp_read_orbit_noaa, input_time_range, probe=probe, errmsg=errmsg, coord=coord, get_name=get_name, suffix=suffix, _extra=ex
...
;---Calibrate the data.
    ...
    dis = get_var_data(out_vars[2])/re+1
...
probe = 'f18'
r_var = dmsp_read_orbit_noaa(time_range, probe=probe, coord='gsm')
