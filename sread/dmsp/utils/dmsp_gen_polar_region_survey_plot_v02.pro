...
; v02 uses the mlt from aacgm_mlon2mlt, v01 uses the mlt from mlon2mlt.
;-

function dmsp_gen_polar_region_survey_plot_v02, input_time_range, probe=probe, $
...
files = dmsp_gen_polar_region_survey_plot_v02(the_time_range, probe=probe, plot_dir=plot_dir, test=test)
...
foreach probe, probes do begin
    files.add, dmsp_gen_polar_region_survey_plot_v02(input_time_range, probe=probe, test=test), extract=1
endforeach
files = files.toarray()
end