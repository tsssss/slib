;+
; Load SSJ data from Madrigal server.
;-

function dmsp_load_ssj_madrigal, input_time_range, probe=probe, id=datatype, $
...
;---Settings for local files.
    ...
    local_base_name = 'dms_%Y%m%d_'+probe_code+'e.*.hdf5'
    ...
    exp_id = 10200+long64(probe_code)
    resolution_code = 's1'
