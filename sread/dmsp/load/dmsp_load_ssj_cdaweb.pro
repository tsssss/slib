...
function dmsp_load_ssj_cdaweb, input_time_range, id=datatype, probe=probe, $
...
;---Init settings.
    ...
    base_name = 'dmsp-'+probe+'_ssj_precipitating-electrons-ions_%Y%m%d_'+version+'.cdf'
    local_path = [local_root,'dmsp'+probe,'ssj','precipitating-electrons-ions','%Y']
    remote_path = [remote_root,'dmsp'+probe,'ssj','precipitating-electrons-ions','%Y']
...
probe = 'f18'
files = dmsp_load_ssj_cdaweb(time_range, probe=probe)
end