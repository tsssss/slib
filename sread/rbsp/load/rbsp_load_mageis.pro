...
function rbsp_load_mageis, input_time_range, id=datatype, probe=probe, $
...
time_range = time_double(['2013-01-01','2013-01-05'])
foreach probe, ['a','b'] do files = rbsp_load_mageis(time_range, id='l3', probe=probe)
end