...
pro rbsp_read_eclipse_flag_gen_file_v01, time_range, probe=probe, filename=data_file, errmsg=errmsg, local_root=local_root
;---Internal, do not check inputs.
    ...
    file_pattern = '"'+rbspx+'_'+time_string(time_range[0],tformat='YYYY')+'_[0-9]{3}_[0-9]{2}.pecl"'
...
function rbsp_read_eclipse_flag, input_time_range, probe=probe, $
...
;---Init settings.
    ...
    remote_path = [remote_root,'efw_flag','eclipse_flag_'+version,rbspx]
    local_path = [local_root,'efw_flag','eclipse_flag_'+version,rbspx]
...
;---Find files, read variables, and store them in memory.
    ...
    if n_elements(nonexist_files) ne 0 then begin
        foreach file, request.nonexist_files do begin
            ...
            routine = 'rbsp_read_eclipse_flag_gen_file_'+version
...
foreach year, years do begin
    ...
    foreach probe, rbsp_probes() do begin
        var = rbsp_read_eclipse_flag(time_range, probe=probe)
    endforeach
endforeach
stop

rbsp_read_eclipse_flag_gen_file_v01, time_double('2013-01-01'), probe='a'
end
