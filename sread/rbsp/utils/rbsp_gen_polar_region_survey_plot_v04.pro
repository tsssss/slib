...
function rbsp_gen_polar_region_survey_plot_v04, input_time_range, probe=probe, $
...
input_time_range = ['2012-10-01','2013-01-01']
;input_time_range = ['2015-01-05','2019-09-01']
probes = ['a','b']
...
foreach day, days do begin
    ...
    foreach probe, probes do begin
        ...
        files = rbsp_gen_polar_region_survey_plot_v04(the_time_range, probe=probe, plot_dir=plot_dir, xpansize=6, test=test)
    endforeach
endforeach
stop
