...
function rbsp_gen_polar_region_survey_plot, input_time_range, probe=probe, $
    ...
    base = 'rbsp_polar_region_survey_'+strjoin(time_string(time_range,tformat='YYYY_MMDD'),'_')+'_rbsp'+probe+'_v02.pdf'
...
foreach day, days do begin
    ...
    foreach probe, probes do begin
        ...
        files = rbsp_gen_polar_region_survey_plot(the_time_range, probe=probe, plot_dir=plot_dir, xpansize=6, test=test)
    endforeach
endforeach
stop
