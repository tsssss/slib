;+
; Load MMS PAD ion keV files (local_only, generated by Sheng Tian)
...
function mms_ld_feeps_pad_ion, input_time_range, id=datatype, probe=probe, $
...
probe = '1'
;file = join_path([homedir(),'mms_ld_pad_ion_kev_test_file.cdf'])
