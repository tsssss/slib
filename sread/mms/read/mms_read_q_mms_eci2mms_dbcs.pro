function mms_read_q_mms_eci2mms_dbcs, input_time_range, probe=probe, errmsg=errmsg
    var_info=var_info, $
    ...
    if n_elements(var_info) eq 0 then var_info = prefix+'q_mms_eci2'+coord+suffix
    ...
    in_var = prefix+'mec_quat_eci_to_'+coord_short
    var_list = list()
