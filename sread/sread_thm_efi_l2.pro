...
function sread_thm_efi_l2, tr0, probes = probe0, filename = fn0, $
...
;---prepare file names.
    type1 = 'efi'   ; use in filename.
    type2 = 'efi'   ; use in path.
...
;---prepare var names.
    ...
    if n_elements(var0s) eq 0 then begin
        ...
        ;var0s = pre0+['eff_dot0_time','eff_dot0_gsm']   ; 1/8 sec resolution.
    endif
...
pos = sread_thm_efi_l2(utr, probes=['a'])
