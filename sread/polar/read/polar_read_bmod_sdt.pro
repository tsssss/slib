;+
; Read Polar model B field that is exported from SDT.
;-

function polar_read_bmod_sdt, input_time_range, probe=probe, errmsg=errmsg, $
    ...
    vec_coord_var = prefix+'bmod_'+coord+suffix
...
;---Read data.
    var_list = list()
    vec_default_var = prefix+'bmod_'+default_coord+suffix
    var_list.add, dictionary($
        'in_vars', 'bmod_spc', $
        'out_vars', vec_default_var, $
        'time_var_name', 'ut_bmod', $
        'time_var_type', 'unix' )
