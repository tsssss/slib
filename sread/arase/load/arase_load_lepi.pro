...
function arase_load_lepi, input_time_range, probe=probe, id=datatype, $
...
;---Init settings.
    ...
    ; Level 3.
    base_name = 'erg_lepi_l3_pa_%Y%m%d_'+version+'.cdf'
    remote_path = [remote_root,'lepi','l3','pa','%Y','%m']
    local_path = [local_root,'lepi','l3','pa','%Y','%m']
    ...
    ; Level 2.
    base_name = ''
    base_name = 'erg_lepi_l2_3dflux_%Y%m%d_'+version+'.cdf'
    remote_path = [remote_root,'lepi','l2','3dflux','%Y','%m']
    local_path = [local_root,'lepi','l2','3dflux','%Y','%m']
...
print, arase_load_lepi(time_range, id='l2%3dflux', probe=probe)
print, arase_load_lepi(time_range, id='l3%pa', probe=probe)
end