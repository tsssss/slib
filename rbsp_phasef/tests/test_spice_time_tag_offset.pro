...
; 
; In this example, we shift r, v, q in time.
;-
...
pro test_spice_time_tag_offset, time_range, probe=probe, time_tag_offset=time_tag_offset
...
date = time_range[0]
probe = 'a'
time_tag_offsets = make_bins([-0.06,0.0],0.02)
foreach time_tag_offset, time_tag_offsets do begin
    test_spice_time_tag_offset, time_range, probe=probe, time_tag_offset=time_tag_offset
endforeach
end
