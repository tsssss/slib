...
probes = ['a']
mission_time_range = time_double(['2019-01-26','2019-12-03'])
probes = ['b']
mission_time_range = time_double(['2019-01-23','2019-12-03'])
...
foreach probe, probes do begin
    ...
    var = rbsp_efw_phasef_read_b1_time_rate(mission_time_range, probe=probe)
