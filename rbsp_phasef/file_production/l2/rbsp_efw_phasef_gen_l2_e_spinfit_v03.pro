...
pro rbsp_efw_phasef_gen_l2_e_spinfit_v03_per_day, date, probe=probe, filename=file, log_file=log_file
...
;---Load data.
    routines = 'phasef_read_'+['e_spinfit_l2','spinaxis_gse','pos_var','efw_qual','orbit_num','hsk']
...
;---Do something.
    ...
    flag_all_var = rename_var(flag_var, output=prefix+'flags_all')
...
;---Save to file.
    ...
    routines = 'rbsp_efw_phasef_save_'+['e_spinfit_l2','spinaxis_gse','pos_var','flags_all','orbit_num','bias_current']+'_to_file'
    foreach routine, routines do begin
...
foreach probe, probes do begin
    ...
    log_file = join_path([root_dir,rbspx,'l2','e-spinfit-mgse','rbsp_efw_phasef_gen_l2_e_spinfit_v03.log'])
    ...
    foreach day, days do begin
        ...
        rbsp_efw_phasef_gen_l2_e_spinfit_v03_per_day, day, probe=probe, filename=file, log_file=log_file
    endforeach
endforeach
...
rbsp_efw_phasef_gen_l2_e_spinfit_v03_per_day, date, probe=probe, filename=file
end
