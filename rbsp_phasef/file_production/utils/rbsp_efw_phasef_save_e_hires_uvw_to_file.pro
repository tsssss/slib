...
pro rbsp_efw_phasef_save_e_hires_uvw_to_file, date, probe=probe, filename=file, errmsg=errmsg, log_file=log_file, saved_vars=new_vars
...
;---Check data availability.
    ...
    tplot_vars = prefix+['efw_esvy','efw_esvy_no_offset']
...
;---Save to CDF.
    ...
    foreach new_var, new_vars, var_id do begin
        ...
        ; Map to new var.
        if cdf_has_var(old_var, filename=file) then begin
...
rbsp_efw_phasef_save_e_hires_uvw_to_file, date, probe=probe, filename=file
end
