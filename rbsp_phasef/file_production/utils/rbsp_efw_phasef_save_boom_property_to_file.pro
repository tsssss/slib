...
pro rbsp_efw_phasef_save_boom_property_to_file, date, probe=probe, filename=file, $
...
;---Check data availability.
    ...
    ;rbsp_efw_phasef_read_boom_property, date, probe=probe, errmsg=errmsg, log_file=log_file
