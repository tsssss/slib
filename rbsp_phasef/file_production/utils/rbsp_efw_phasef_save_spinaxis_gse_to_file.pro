...
pro rbsp_efw_phasef_save_spinaxis_gse_to_file, date, probe=probe, filename=file, $
...
;---Check data availability.
    ...
    ; Needs rbspx_spinaxis_gse.
    ;rbsp_efw_phasef_read_spinaxis_gse, date, probe=probe, errmsg=errmsg, log_file=log_file
    tplot_vars = prefix+['spinaxis_gse']
