...
pro rbsp_efw_phasef_save_esvy_despun_to_file, date, probe=probe, filename=file, errmsg=errmsg, log_file=log_file, saved_vars=new_vars
...
;---Check data availability.
    ...
    ; Needs rbspx_esvy_mgse.
    ;rbsp_efw_phasef_read_esvy_despun, date, probe=probe, errmsg=errmsg, log_file=log_file
    tplot_vars = prefix+'esvy_mgse'
...
rbsp_efw_phasef_save_bias_current_to_file, date, probe=probe, filename=file
end
