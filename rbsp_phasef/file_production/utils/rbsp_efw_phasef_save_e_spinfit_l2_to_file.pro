...
pro rbsp_efw_phasef_save_e_spinfit_l2_to_file, date, probe=probe, filename=file, errmsg=errmsg, log_file=log_file, saved_vars=new_vars
...
;---Check data availability.
    ...
    ; Needs rbspx_e_spinfit_mgse, rbspx_evxb_mgse, rbspx_ecoro_mgse.
    ;rbsp_efw_phasef_read_e_spinfit_l2, date, probe=probe, errmsg=errmsg, log_file=log_file
    tplot_vars = prefix+['e_spinfit_mgse','evxb_mgse','ecoro_mgse']
...
;---Save to CDF.
    new_vars = ['efield_spinfit_mgse','VxB_mgse','efield_coro_mgse']
