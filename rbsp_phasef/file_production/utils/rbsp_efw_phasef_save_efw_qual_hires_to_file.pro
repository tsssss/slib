...
pro rbsp_efw_phasef_save_efw_qual_hires_to_file, date, probe=probe, filename=file, errmsg=errmsg, log_file=log_file, saved_vars=new_vars
...
;---Save to CDF.
    ...
    foreach new_var, new_vars, var_id do begin
        ...
        labels = get_setting(tplot_var,'labels')
...
rbsp_efw_phasef_save_efw_qual_hires_to_file, date, probe=probe, filename=file
end
