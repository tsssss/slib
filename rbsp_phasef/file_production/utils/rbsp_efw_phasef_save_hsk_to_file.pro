;+
; Save bias current, usher and guard voltages for a given date to a given CDF.
;
...
pro rbsp_efw_phasef_save_hsk_to_file, date, probe=probe, filename=file, errmsg=errmsg, log_file=log_file, saved_vars=new_vars
...
;---Check data availability.
    ...
    ; Needs rbspx_ibias.
    ;phasef_read_efw_hsk, date, probe=probe, errmsg=errmsg, log_file=log_file
    tplot_vars = prefix+['ibias','usher','guard']
...
;---Save to CDF.
    new_vars = ['bias_current','usher_voltage','guard_voltage']
