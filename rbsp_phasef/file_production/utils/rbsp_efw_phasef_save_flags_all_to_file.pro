...
pro rbsp_efw_phasef_save_flags_all_to_file, date, probe=probe, filename=file, errmsg=errmsg, log_file=log_file, saved_vars=new_vars
...
rbsp_efw_phasef_save_flags_all_to_file, date, probe=probe, filename=file
end
