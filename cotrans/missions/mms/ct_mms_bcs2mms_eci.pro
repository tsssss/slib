...
function ct_mms_bcs2mms_eci, vec0, times, probe=probe, errmsg=errmsg
    errmsg = ''
    retval = !null
    ...
    quaternion = shift(quaternion,0,1)  ; mms quaternion in <x,y,z,w>, need to convert to <w,x,y,z>.
    quaternion = qslerp(quaternion, ut_cotran, times, eq_tolerance=1d-8)
